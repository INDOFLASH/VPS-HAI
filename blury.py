...
async def genkey(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user_id in ADMIN_IDS:
        ...
        response = f"ONLY OWNER CAN USE💀OWNER OWNER- @TG_FLASH92..."
...
async def redeem(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if len(command) == 1:
        ...
        if key in keys:
            ...
            response = f"Invalid or expired key buy from OWNER- @TG_FLASH92..."
    else:
        response = f"Usage: /redeem <key> if you don't  have  buy from  @TG_FLASH92..."
...
async def broadcast(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user_id in ADMIN_IDS:
        ...
        response = "ONLY OWNER CAN USE @TG_FLASH92."
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    response = (
        "Welcome to the Flooding Bot by OWNER- @TG_FLASH92...! Here are the available commands:\n\n"
        "Admin Commands:\n"
